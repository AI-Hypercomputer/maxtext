...
python3 xpk/xpk.py workload create --cluster maxtext-a3-20nodes --workload yooh-llama-$(date +%Y-%m-%d-%H-%M) \
    ...
    --command "NCCL_DEBUG=WARN python3 MaxText/train.py MaxText/configs/base.yml dataset_path=gs://maxtext-dataset base_output_directory=gs://runner-maxtext-logs 
