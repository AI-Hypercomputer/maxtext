...
ARG SKIP_REQUIREMENTS
ENV ENV_SKIP_REQUIREMENTS=$SKIP_REQUIREMENTS
...
RUN echo "Running command: bash setup.sh MODE=$ENV_MODE JAX_VERSION=$ENV_JAX_VERSION LIBTPU_GCS_PATH=${ENV_LIBTPU_GCS_PATH} SKIP_REQUIREMENTS=${ENV_SKIP_REQUIREMENTS}"
RUN bash setup.sh MODE=${ENV_MODE} JAX_VERSION=${ENV_JAX_VERSION} LIBTPU_GCS_PATH=${ENV_LIBTPU_GCS_PATH} SKIP_REQUIREMENTS=${ENV_SKIP_REQUIREMENTS}
