...
source /usr/local/google/home/surajkolla/VENVS/ubench/bin/activate
...
export ARTIFACT_DIR="gs://ubench-logs/mlperf-ub3uaw"
export WORKLOAD_IMAGE="gcr.io/cloud-tpu-multipod-dev/integrate_v2:gmmv2_bf16_log27"
export WORKLOAD_NAME="mlperf-ub3uaw"
...
xpk workload create \
  ...
  --output-manifest-file=/tmp/ubench_recipe/mlperf-ub3uaw/recipe_for_github/k8s/k8s_manifest.yaml \
   \
