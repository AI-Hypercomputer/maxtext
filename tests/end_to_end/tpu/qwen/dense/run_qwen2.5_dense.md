...
transformer architecture. You can find more information in the [blog](https://qwenlm.github.io/blog/qwen2.5/) and
the [model card](https://huggingface.co/Qwen/Qwen2.5-7B). The currently supported models
