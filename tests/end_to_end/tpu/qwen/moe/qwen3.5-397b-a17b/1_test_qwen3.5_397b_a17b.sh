...
# This file is documentation for how to get started with Qwen3.5-397B.
...
export MODEL_NAME="${MODEL_NAME:-qwen3.5-397b-a17b}"
...
export BASE_OUTPUT_PATH="${BASE_OUTPUT_PATH:-gs://your-gcs-bucket/qwen3.5-397b-a17b_maxtext_ckpt}"
