...
export EXTRA_FLAGS="sa_block_q=512 sa_block_kv=512 sa_block_kv_compute=512 sa_block_q_dkv=512 sa_block_kv_dkv=512 sa_block_kv_dkv_compute=512 sa_block_q_dq=512 sa_block_kv_dq=512 remat_policy=custom decoder_layer_input=offload float32_weight_sum=False use_tokamax_splash=True use_random_routing=True attention=flash use_tokamax_gmm=False prefuse_moe_weights=True moe_fsdp_use_two_stage_all_gather=True"
