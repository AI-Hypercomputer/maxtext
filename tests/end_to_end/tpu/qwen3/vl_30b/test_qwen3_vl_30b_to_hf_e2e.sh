...
# Qwen3-VL-30B-A3B MaxText checkpoint to Hugging Face format. Can be run on a v4-8.
...
export MODEL_VARIATION='vl_30b'
export HF_MODEL=Qwen/Qwen3-VL-30B-A3B-Instruct
