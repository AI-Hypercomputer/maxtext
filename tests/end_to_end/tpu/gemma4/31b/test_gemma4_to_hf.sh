...
# Gemma4-31B MaxText checkpoint to Hugging Face format. Can be run on a v5p-8.
...
# 2. Provide a MaxText-format Gemma4-31B checkpoint via CKPT_PATH.
#    One can be produced with tests/end_to_end/tpu/gemma4/31b/convert_gemma4.sh.
...
# Path to a pre-existing MaxText checkpoint for gemma4-31b. Must match USE_SCAN_LAYERS.
# Run tests/end_to_end/tpu/gemma4/31b/convert_gemma4.sh to produce one.
