...
`test_gathered_fsdp_weight_on_a_four_device_cpu_mesh` re-execs the module with the
...
_DRIVER = "test_gathered_fsdp_weight_on_a_four_device_cpu_mesh"
_PASSED = re.compile(r"(\d+) passed")


def test_gathered_fsdp_weight_on_a_four_device_cpu_mesh():
