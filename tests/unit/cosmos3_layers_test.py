...
from maxtext.m3.models import cosmos3
import numpy as np
import pytest
...
class Cosmos3MoTDecoderLayerStructureTest(parameterized.TestCase):
  ...
  def test_config_construction(self):
    """Verifies config-driven construction from Cosmos3Config."""
    cfg = Cosmos3Config(
        hidden_size=64,
        head_dim=16,
        num_attention_heads=4,
    ...
    layer = Cosmos3MoTDecoderLayer.from_config(cfg, rngs=nnx.Rngs(0))
