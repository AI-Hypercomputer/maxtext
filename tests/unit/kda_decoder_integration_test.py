...
def _kda_pyconfig(**kwargs):
  ...
  defaults = {
      ...
      "kda_lower_bound": -5.0,
      # base.yml defaults packing=true with max_segments_per_seq=-1; KDA rejects
      # that combination at config time because the kernel needs a static upper
      # bound on packed segments.
