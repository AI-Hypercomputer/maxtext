...
LLAMA_CONFIGS = [
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "llama2_7b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "llama2_70b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "llama3_8b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "llama3_70b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "llama3.1_405b.yml"),
...
MISTRAL_CONFIGS = [
    ...
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "mixtral_8x1b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "mixtral_8x2b.yml"),
    os.path.join(CONFIGS_DIR, "models", "gpu", "models", "mixtral_8x7b.yml"),
]
