...
class QKClipMLATest(unittest.TestCase):
  ...
  def test_mla_dot_product_integration(self):
    ...
    # Hoist intermediates for apply_qk_clip
    if "attention_op" in intermediates and "max_logits" in intermediates["attention_op"]:
      intermediates["max_logits"] = intermediates["attention_op"]["max_logits"]
  ...
  def test_cross_check_dot_vs_splash(self):
    ...
    if "attention_op" in intermediates_dot:
      intermediates_dot["max_logits"] = intermediates_dot["attention_op"]["max_logits"]
    ...
    if "attention_op" in intermediates_splash:
      intermediates_splash["max_logits"] = intermediates_splash["attention_op"]["max_logits"]
