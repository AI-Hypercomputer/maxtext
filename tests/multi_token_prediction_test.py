...
from maxtext.src.maxtext.layers.decoders import Decoder, DecoderLayer
from maxtext.src.maxtext.layers import multi_token_prediction  # The class under test
