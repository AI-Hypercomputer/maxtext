...
def test_batch_adapter_preserves_full_token_cft_supervision():
  raw = _raw_batch()
  raw["corruption_mask"] = jnp.ones_like(raw["corruption_mask"])
  raw["targets_loss_mask"] = jnp.ones_like(raw["targets_loss_mask"])
...
def test_completion_only_adapter_rejects_prompt_supervision():
  raw = _raw_batch()
  raw["corruption_mask"] = raw["corruption_mask"].at[0, 0].set(1)
  raw["targets_loss_mask"] = raw["targets_loss_mask"].at[0, 0].set(1)
...
def test_completion_only_adapter_rejects_future_prompt_in_block():
  raw = _raw_batch()
  raw["completion_mask"] = raw["completion_mask"].at[0, 5].set(0)
  raw["corruption_mask"] = raw["corruption_mask"].at[0, 5].set(0)
  raw["targets_loss_mask"] = raw["targets_loss_mask"].at[0, 5].set(0)
