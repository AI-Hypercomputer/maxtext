...
from maxtext.src.maxtext.globals import MAXTEXT_ASSETS_ROOT, MAXTEXT_PKG_DIR, MAXTEXT_REPO_ROOT
from maxtext.src.maxtext.input_pipeline import _tfds_data_processing
