...
python MaxText/experimental_decode_time_autoregress.py MaxText/configs/base.yml assets_path=gs://maxtext-gamma/gamma  per_device_batch_size=16 run_name=runner_2024-02-29-18-00 max_prefill_predict_length=1024 max_target_length=2048 dataset_path=gs://maxtext-dataset steps=10 async_checkpointing=false scan_layers=false model_name=gamma-7b attention=recommended
