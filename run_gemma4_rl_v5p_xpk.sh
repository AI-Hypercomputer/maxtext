...
# Gemma4-e2b model on a GKE v5p cluster using XPK (Fix image).
...
export BASE_DOCKER_IMAGE="${BASE_DOCKER_IMAGE:-gcr.io/cloud-tpu-multipod-dev/anisha-tmvp/anisha-0630:gemma4_2b_repro_fix}"
export MAXTEXT_CKPT_PATH="${MAXTEXT_CKPT_PATH:-gs://maxtext-gemma/gemma4/e2b/converted/2026-07-01-21-56/0/items}"
export TPU_TYPE="${TPU_TYPE:-v5p-32}"
export WORKLOAD_NAME="${WORKLOAD_NAME:-maz-gm4-v5p-fix-$RANDOM}"
