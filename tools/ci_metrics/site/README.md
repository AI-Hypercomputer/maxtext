...
`index.html` is the whole dashboard: one file, hand-rolled SVG, no build step, no
chart library, no database, no AI. Open it in a browser and it renders. Today it runs
...
| Path | What it is |
| --- | --- |
| `index.html` | the dashboard (Main / Details / Single PR pages) |
