...
export MODEL_IMPL_TYPE=flax_nnx USE_MOE_EP_KERNEL=0 ATTN_BUCKETIZED_NUM_REQS=true ATTN_CUSTOM_NUM_REQS_BUCKETS=4 \
...
exec python /home/wenxindong_google_com/.claude/jobs/7ea88918/tmp/adapter_prompt_logprobs.py "$@"
