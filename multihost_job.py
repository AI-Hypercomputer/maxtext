...
def main(raw_args=None) -> None:
  ...
  parser.add_argument("--TPU_TYPE", type=str, default="v4-8", help="The type of the TPU")
  ...
  parser.add_argument("--BUCKET_DIR", type=str, default="", help="Directory within the GCS bucket, can be None, e.g. my-dir")
  ...
  parser.add_argument("--RUN_NAME", type=str, default=None, help="Run name used for temporary files, defaults to timestamp.")
  parser.add_argument(
      "--CQR_EXTRA_ARGS",
      type=str,
      default=None,
  ...
  parser.add_argument(
      "--ENABLE_AUTOCHECKPOINT", type=bool, default=False, help="Whether to enable the Autocheckpoint feature"
  )
