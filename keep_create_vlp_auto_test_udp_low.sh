...
do
    ...
    QR_ID=$RUN_NAME
    python3 multihost_job.py --NUM_SLICES=$NUM_SLICES --RUN_NAME=$RUN_NAME --BUCKET_NAME=$BUCKET_NAME --PROJECT=${PROJECT} --ZONE=${ZONE} --CQR_EXTRA_ARGS="--metadata priority-group=low" \
