...
RUN apt-get update && apt-get install -y apt-utils git curl gnupg procps iproute2 ethtool cmake pkg-config build-essential ninja-build gcc-12 g++-12 dnsutils && rm -rf /var/lib/apt/lists/*
