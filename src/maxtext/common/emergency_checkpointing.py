...
stay on Orbax v0 — isolated here so the standard path stays v0-free. The dispatch
functions in ``checkpointing.py`` delegate to :func:`is_emergency_manager`,
:func:`save`, and :func:`restore` for these managers.
"""
...
def is_emergency_manager(checkpoint_manager) -> bool:
  """True for the v0 emergency / replicator managers."""
  return isinstance(checkpoint_manager, _MANAGERS)
