...
def QWEN3_5_MAXTEXT_TO_HF_PARAM_MAPPING(config, maxtext_config, scan_layers=False):
  ...
  """
  num_main_layers = getattr(maxtext_config, "base_num_decoder_layers", None) or config["text_config"]["num_hidden_layers"]
  ...
  num_experts = getattr(maxtext_config, "num_experts", 1) or config.get("text_config", config).get("num_experts", 1)
