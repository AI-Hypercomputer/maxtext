...
try:
  qwen3_5_9b_config = transformers.Qwen3_5Config(**qwen3_5_9b_dict)  # pyrefly: ignore[missing-attribute]
except AttributeError:
  qwen3_5_9b_config = PTConfig(**qwen3_5_9b_dict)  # pytype: disable=wrong-arg-types
