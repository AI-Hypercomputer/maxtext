...
deepseek3_tiny_dict = deepseek3_671b_dict.copy()
deepseek3_tiny_dict.update({
    "hidden_size": 64,
...
deepseek3_tiny_config = transformers.DeepseekV3Config(**deepseek3_tiny_dict)
...
HF_MODEL_CONFIGS = {
    ...
    "deepseek3-tiny": deepseek3_tiny_config,
