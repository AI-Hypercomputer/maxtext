...
# Published config: microsoft/Phi-4-mini-instruct, revision cfbefacb99257ffa30c83adab238a50856ac3083.
phi4_mini_config = transformers.Phi3Config(
    **{
...
HF_MODEL_CONFIGS = {
    "phi4-mini-instruct": phi4_mini_config,
