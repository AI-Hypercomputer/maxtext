...
Supported formats and frameworks:
  ...
  2. MaxText Model Architecture: On-the-fly. 
     - Lightweight with near-zero cost. Traces JAX shapes abstractly; evaluates theoretical parameters dynamically 
        without executing compute or allocating VRAM/HBM.
  3. Orbax Checkpoints: Pre-saved disk/GCS file.
     - Lightweight with near-zero cost. Reads structural metadata trees instantly without pulling underlying 
        TensorStore data chunks.
