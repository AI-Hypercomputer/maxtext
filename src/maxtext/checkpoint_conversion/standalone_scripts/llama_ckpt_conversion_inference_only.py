...
Example cmd:
To save a ckpt
python3 -m maxtext.checkpoint_conversion.standalone_scripts.llama_or_mistral_ckpt --base-model-path <path/to/meta/ckpt> \
...
def convert(base_model_path, maxtext_model_path, model_size):
  ...
  if checkpoint_manager is not None:
    ...
    if checkpointing.reached_preemption(0):
