...
# reference: https://github.com/huggingface/transformers/blob/9a0fe3f5dd36ffe1888133f09eb03f1eb14b8a6e/src/transformers/integrations/finegrained_fp8.py#L987  # pylint: disable=line-too-long
...
# reference: https://github.com/huggingface/transformers/blob/9a0fe3f5dd36ffe1888133f09eb03f1eb14b8a6e/src/transformers/integrations/finegrained_fp8.py#L996  # pylint: disable=line-too-long
...
if __name__ == "__main__":
  ...
  parser.add_argument("--input-path", type=str, required=True, help="Path to DeepSeek FP8/FP4 Hugging Face folder")
  parser.add_argument("--output-path", type=str, required=True, help="Directory to save output BF16 weights")
  parser.add_argument("--cache-size", type=int, default=2, help="Max cached files in RAM during indexing lookup")
