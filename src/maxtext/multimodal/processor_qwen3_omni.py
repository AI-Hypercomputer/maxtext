...
def preprocess_mm_data_qwen3_omni(config):
  ...
  if config.image_path:
    ...
    # Reshape to align with current Qwen3OmniMoeVisionEncoder, which carries grid_thw infomation
    pixel_values = np.reshape(pixel_values, (1, config.num_channels_for_vit, config.temporal_patch_size_for_vit*pixel_grid_thw[0, 0], config.patch_size_for_vit*pixel_grid_thw[0, 1], config.patch_size_for_vit*pixel_grid_thw[0, 2]))
