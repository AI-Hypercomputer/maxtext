...
from .processor_vae_image import VaeImageProcessor, is_valid_image, is_valid_image_imagelist


class VaeVideoProcessor(VaeImageProcessor):
...
VideoProcessor = VaeVideoProcessor
