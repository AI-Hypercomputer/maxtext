...
def preprocess_mm_data(config):
  ...
  elif config.model_name in ["qwen3-omni-30b-a3b", "qwen3.5-397b-a17b", "qwen3.5-35b-a3b"]:
...
def preprocess_image_for_training(image, model_name):
  ...
  elif model_name in ["qwen3-omni-30b-a3b", "qwen3.5-397b-a17b", "qwen3.5-35b-a3b"]:
...
def get_dummy_image_shape_for_init(model_name, batch_size=1, num_image_per_sequence=1):
  ...
  elif model_name.startswith("qwen3-omni-30b-a3b") or model_name.startswith("qwen3.5-397b-a17b") or model_name.startswith("qwen3.5-35b-a3b"):
...
def get_bidirectional_mask_vision(config, decoder_input_tokens, is_video: bool = False):
  ...
  if config.model_name in ["gemma3-4b", "gemma3-12b", "gemma3-27b"]:
    ...
    bidirectional_mask_vision = (decoder_input_tokens == tokens.image) | (decoder_input_tokens == tokens.video)
