...
#      bash src/maxtext/training_engine/run_all_parity_tests.sh
#
...
echo "=========================================================================="
python3 src/maxtext/training_engine/compare_training_engine.py model_name=simple_mlp test_suite=eager_all

echo ""
echo "=========================================================================="
echo "=== [Step 4] JIT Evaluation: Standalone train_step vs Engine (Llama 8B) ==="
echo "=========================================================================="
python3 src/maxtext/training_engine/compare_training_engine.py "${LLAMA_OVERRIDES[@]}" test_suite=jit_train_step

echo ""
echo "=========================================================================="
echo "=== [Step 5] JIT Evaluation: Auxiliary Metrics & Telemetry (Llama 8B)  ==="
echo "=========================================================================="
python3 src/maxtext/training_engine/compare_training_engine.py "${LLAMA_OVERRIDES[@]}" test_suite=jit_auxiliary_metrics

echo ""
echo "=========================================================================="
echo "=== [Step 6] JIT Evaluation: Multi-Microbatch Gradient Accumulation    ==="
echo "=========================================================================="
python3 src/maxtext/training_engine/compare_training_engine.py "${LLAMA_OVERRIDES[@]}" test_suite=jit_gradient_accumulation
