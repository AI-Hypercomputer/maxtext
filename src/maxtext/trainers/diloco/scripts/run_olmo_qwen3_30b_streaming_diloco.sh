...
#      XPK_CLUSTER="mlperf-v5p" XPK_ZONE="europe-west4-b" XPK_PROJECT="cloud-tpu-multipod-dev" \
#      XPK_DEVICE_TYPE="v5p-128" XPK_NUM_SLICES="2" RUN_NAME="qw3-olmo-dlco-01" WORKLOAD_NAME="qw3-olmo-01" \
#      BASE_OUTPUT_DIRECTORY="gs://chriszuo-maxtext-logs" OLMO_GCS_BASE="gs://chriszuo-maxtext-datasets" \
...
if [ -n "${XPK_RESERVATION:-}" ] && [ "${XPK_RESERVATION}" != "NONE" ]; then
  XPK_ARGS+=(--reservation "${XPK_RESERVATION}")
fi
