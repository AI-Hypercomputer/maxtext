...
tokenizer_path=Qwen/Qwen3-235B-A22B \\
run_name={{ run_name }} \\
base_output_directory={{ base_output_directory }} \\
hf_access_token={{ hf_token }} \\
async_scheduling=False max_target_length=640 \\
...
vllm_additional_config='{maxtext_config: {model_name: qwen3-235b-a22b, model_call_mode: inference, allow_split_physical_axes: true, log_config: false, weight_dtype: bfloat16}}' \\
