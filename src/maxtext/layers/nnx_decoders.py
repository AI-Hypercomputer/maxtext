...
from maxtext.layers import initializers, linears, mhc, normalizations, quantizations, nnx_wrappers as max_nnx_wrappers
...
class NNXDecoder(nnx.Module):
  ...
  def _create_scanned_layers(
    ...
    return max_nnx_wrappers.create_scanned_layers(
  ...
  def _apply_gemma4_scanned_blocks(
    ...
    block_unroll = max(1, cfg.base_num_decoder_layers // cfg.inhomogeneous_layer_cycle_interval)
    if scan_length > 0:
