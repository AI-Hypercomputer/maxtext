    ...
    if cfg.scan_layers:
      ...
      for lyr, layer in enumerate(self.layers):
        ...
        if policy is not None:
          ...
          def _make_pure_layer_fn(captured_graphdef, captured_kwargs):
            def pure_layer_fn(state_in, y_in, kv_in):
              merged_layer = nnx.merge(captured_graphdef, state_in)
            ...
            return pure_layer_fn

          pure_layer_fn = _make_pure_layer_fn(graphdef, layer_call_kwargs)
