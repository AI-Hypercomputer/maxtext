...
from maxtext.src.maxtext.common.common_types import Config, DecoderBlockType, ShardMode
from maxtext.src.maxtext.common.common_types import MODEL_MODE_AUTOREGRESSIVE, MODEL_MODE_PREFILL, MODEL_MODE_TRAIN
...
from maxtext.src.maxtext.layers.nnx_decoders import NNXDecoderLayer, NNXSequentialPipelineStage, NNXScannedPipelineStage
from maxtext.src.maxtext.layers import quantizations
from maxtext.src.maxtext.layers.attentions import attention_as_linen
from maxtext.src.maxtext.layers.embeddings import attend_on_embedding, embed_as_linen, positional_embedding_as_linen
