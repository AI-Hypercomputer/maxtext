...
def run_agent_workflow(run_id: str, model_name: str, failure_log: str, report_source: str = ""):
    ...
    try:
        ...
        plan_json = {
            ...
            "structured_plan": [
                "Step 1: Check if failure is Array has been deleted. If so, pass overrides remat_policy=minimal via trigger_airflow_dag without editing Python files.",
    ...
    fixer_system = (
        ...
        "- For forward pass or eval verification tasks, if the error is 'RuntimeError: Array has been deleted', DO NOT edit normalizations.py or any nnx code. Fix via maxtext_overrides (remat_policy=minimal).\n"
