...
"""Test & Verification Script for Stitched Omni Qwen3-VL-4B + Qwen3-14B 3-Stage Model.

Verifies:
1. Checkpoint Stitching (restores Qwen3-VL-4B ViT + Qwen3-14B LLM + fresh MLP projector)
2. PyTree Parameter Shapes, LayerNorm scale/bias initializations
3. End-to-End Multimodal Forward Pass & Logits Verification

Usage:
  JAX_PLATFORMS=cpu python3 src/maxtext/experimental/omni_qwen_14b_3stage/test_stitch_qwen_14b.py
"""
...
def main(argv):
  ...
  max_logging.log("=" * 70)
  max_logging.log(">>> ALL OMNI QWEN3-VL + QWEN3-14B 3-STAGE TESTS PASSED SUCCESSFULLY! 🎉")
  max_logging.log("=" * 70)
