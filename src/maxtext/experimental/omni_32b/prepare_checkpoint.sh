#!/bin/bash
# ==============================================================================
# Download, Convert, and Stitch Checkpoints for Omni Gemma3-4B + Qwen3-32B
# ==============================================================================
...
BASE_OUTPUT_DIRECTORY="${BASE_OUTPUT_DIRECTORY:-${GCS_BUCKET}/omni-gemma3-qwen3-32b/checkpoints}"
...
LLM_MAXTEXT_MODEL="qwen3-32b"
LLM_HF_REPO="Qwen/Qwen3-32B"

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
MAXTEXT_ROOT="$(git -C "${SCRIPT_DIR}" rev-parse --show-toplevel 2>/dev/null || (cd "${SCRIPT_DIR}/../../../../.." && pwd))"
OMNI_CONFIG_PATH="${SCRIPT_DIR}/maxtext-omni-gemma3-qwen3-32b.yml"
...
# Step 2: Download & Convert Language Model (Qwen3-32B) from Hugging Face -> MaxText (scan_layers=True)
echo ""
echo "============================================================"
...
echo ""
echo "============================================================"
echo ">>> Step 3/3: Stitching Vision and LLM into unified Omni 32B checkpoint..."
echo "============================================================"
(
  cd "${MAXTEXT_ROOT}"
