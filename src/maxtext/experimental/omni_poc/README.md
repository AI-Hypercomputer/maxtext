...
├── train_sft_omni.py                               # Training entry point (SFT)
├── eval_sft_omni.py                                # Benchmark evaluation entry point
│
├── configs/
│   ├── pretrain-maxtext-omni-gemma3-qwen3-chartnet.yml # Stage 1: projector alignment config (ChartNet)
│   └── sft-maxtext-omni-gemma3-qwen3.yml           # Stage 2: projector task fine-tuning config (ChartQA)
│
├── utils/
