...
class Attention(BaseModel):
  ...
  use_tokamax_splash: bool = Field(False, description="Whether to use tokamax splash attention kernel directly.")
  use_tokamax_splash_attention_api: bool = Field(False, description="Whether to use tokamax splash attention API.")
