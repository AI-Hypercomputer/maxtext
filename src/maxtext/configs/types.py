...
import jax
from maxtext.src.maxtext.common.common_types import AttentionType, DecoderBlockType, ReorderStrategy, ShardMode, CustomRule, VisionEncoderBlockType
...
from maxtext.src.maxtext.utils.globals import MAXTEXT_ASSETS_ROOT, HF_IDS
