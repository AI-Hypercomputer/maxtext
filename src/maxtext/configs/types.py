...
class LoRA(BaseModel):
  ...
  lora_weight_qtype: str | None = Field(
      None,
      description=("TODO: not working. Optional quantization type for QLoRA (e.g., 'nf4'). If set, QLoRA is applied."),
  )
  lora_tile_size: NonNegativeInt | None = Field(
      None,
      description="TODO: not working. Optional tile size for QLoRA (e.g., 128 or 256).",
  )
