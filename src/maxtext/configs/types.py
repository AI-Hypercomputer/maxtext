...
class AttentionIndexer(BaseModel):
  ...
  use_approx_top_k: bool = Field(False, description="Whether to use approximate top-k selection for the indexer on TPU.")
  approx_top_k_recall: float = Field(0.95, description="Recall target for approximate top-k selection.")
