  ...
  def set_derived_and_validate_values(self) -> "MaxTextConfig":
    ...
    if self.num_experts > 1:
      ...
      if (
          ...
          and self.decoder_block not in (DecoderBlockType.DEEPSEEK, DecoderBlockType.DEEPSEEK4, DecoderBlockType.QWEN3_NEXT)
      ):
        raise ValueError("Loss-free load balancing is only supported for the DeepSeek, DeepSeek4, and Qwen3-Next decoder blocks.")
