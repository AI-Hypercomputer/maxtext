...
from maxtext.src.maxtext.common.common_types import Array, AttentionType, BATCH, Config, DType, EMBED, LENGTH, MODEL_MODE_AUTOREGRESSIVE, MODEL_MODE_TRAIN
from maxtext.src.maxtext.common.common_types import HyperConnectionType
from maxtext.src.maxtext.common.common_types import KV_BATCH, KV_HEAD
...
from maxtext.src.maxtext.layers import mhc
...
from maxtext.src.maxtext.layers.initializers import nd_dense_init, variable_to_logically_partitioned
...
from maxtext.src.maxtext.utils.sharding import get_logical_axis_rules, logical_to_mesh_axes
...
class Qwen3NextGatedDeltaNet(nnx.Module):
  ...
  def __call__(
    ...
    if getattr(cfg, "use_gdn_kernel", False) and getattr(
      ...
      from maxtext.src.maxtext.models.hybrid_gdn import hybrid_fused_conv1d_gdn
