  ...
  def __call__(
    ...
    if use_paged_state:
      ...
      try:
        ...
        from tpu_inference.layers.common.utils import (  # pylint: disable=import-outside-toplevel
...
class Qwen3NextScannableBlock(nnx.Module):
  ...
  Linear attention layers (local) are scanned via `nnx_scan.apply_scanned_layers`
