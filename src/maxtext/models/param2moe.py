...
"""Decoder layer definition for Param2 MoE."""
...
class Param2MoEDenseLayer(nnx.Module):
  """Param2 Dense Layer (similar to standard Llama/Qwen dense layer)."""
...
class Param2MoELayer(nnx.Module):
  """Param2 MoE Layer (uses RoutedAndSharedMoE)."""
  ...
  def __init__(
    ...
    self.MoeBlock_0 = moe.RoutedAndSharedMoE(
        config=config,
        mesh=mesh,
  ...
  def __call__(
    ...
    mlp_lnx, load_balance_loss, _ = self.MoeBlock_0(hidden_states, input_ids=decoder_input_tokens)
    mlp_lnx = nn.with_logical_constraint(mlp_lnx, self.activation_axis_names)
...
Param2MoEDenseLayerToLinen = nnx_wrappers.to_linen_class(
    Param2MoEDenseLayer,
    base_metadata_fn=initializers.variable_to_logically_partitioned,
)

Param2MoELayerToLinen = nnx_wrappers.to_linen_class(
    Param2MoELayer,
    base_metadata_fn=initializers.variable_to_logically_partitioned,
)
