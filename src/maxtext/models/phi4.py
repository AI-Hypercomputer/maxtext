...
"""Phi4 transformer model definition."""
...
class Phi4DecoderLayer(nnx.Module):
  """Transformer decoder layer specific for Phi4."""
  ...
  def __init__(
    ...
    self.self_attention = Attention(
        ...
        partial_rotary_factor=config.partial_rotary_factor,  # Crucial for Phi4 partial RoPE
        rngs=rngs,
    )
...
Phi4DecoderLayerToLinen = nnx_wrappers.to_linen_class(
    Phi4DecoderLayer,
