...
def pad_to_tpu_lanes(size: int, lane_size: int = TPU_V5P_SUBCORE_LANE_SIZE) -> int:
  """Rounds up size to nearest multiple of lane_size."""
  return ((size + lane_size - 1) // lane_size) * lane_size
