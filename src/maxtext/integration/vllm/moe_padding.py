...
def compute_padded_moe_mlp_dim(
  ...
  The GMM_v2 kernel requires the MLP dimension per expert to be a multiple of
  at least 2x the number of TPU lanes (e.g. 2 * 128 = 256) per tensor parallel shard.
