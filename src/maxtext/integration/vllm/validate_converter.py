...
def validate_converter(argv) -> None:
  ...
  #       direct_maxtext_sync=True,  use_weight_converter=True  -> mode 1 new
  #         (WeightConverter(rules=None))
  #       direct_maxtext_sync=True,  use_weight_converter=False -> mode 1 legacy
  #         (tunix transfer_state_directly)
  #       direct_maxtext_sync=False, use_weight_converter=True  -> mode 2 new
  #         (WeightConverter(rules=MODEL_TO_CONVERSION_RULES[...]))
  ...
  if run_full_sync:
    ...
    _check_leaf_structure_unchanged(pre_sync_leaf_signature, _leaf_path_signature(sampler.transformer_state), sync_label)
