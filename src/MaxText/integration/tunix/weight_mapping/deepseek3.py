  ...
  def to_hf_mapping():
      mapping = {
          ...
          "base.decoder.layers.pre_self_attention_layer_norm.scale": (
              "model.layers.*.input_layernorm.weight", (None, "layer")
          ),
          "base.decoder.layers.post_self_attention_layer_norm.scale": (
              "model.layers.*.post_attention_layernorm.weight", (None, "layer")
          ),
          # MLA Norms
          "base.decoder.layers.self_attention.kv_norm.scale": (
              "model.layers.*.self_attn.kv_a_layernorm.weight", (None, "layer")
          ),
          "base.decoder.layers.self_attention.q_norm.scale": (
              "model.layers.*.self_attn.q_a_layernorm.weight", (None, "layer")
          ),
          # MLA Projections
          ...
          "base.decoder.layers.self_attention.wq_a.kernel": (
              "model.layers.*.self_attn.q_a_proj.weight", (None, "layer", "model", None)
          ),
          "base.decoder.layers.self_attention.wq_b.kernel": (
              "model.layers.*.self_attn.q_b_proj.weight", (None, "layer", "model", None)
          ),
          "base.decoder.layers.self_attention.wkv_a.kernel": (
              "model.layers.*.self_attn.kv_a_proj_with_mqa.weight", (None, "layer", "model", None)
          ),
          "base.decoder.layers.self_attention.wkv_b.kernel": (
              "model.layers.*.self_attn.kv_b_proj.weight", (None, "layer", "model", None)
          ),
          "base.decoder.layers.self_attention.out.kernel": (
              "model.layers.*.self_attn.o_proj.weight", ("model", "layer", None, None)
          ),

          # ==============================================================================
          # DENSE MLP LAYERS (Map to HF keys for safety/consistency)
          # ==============================================================================
          "base.decoder.layers.mlp.wi_0.kernel": (
              "model.layers.*.mlp.gate_proj.weight", (None, "layer", "model")
          ),
          "base.decoder.layers.mlp.wi_1.kernel": (
              "model.layers.*.mlp.up_proj.weight", (None, "layer", "model")
          ),
          "base.decoder.layers.mlp.wo.kernel": (
              "model.layers.*.mlp.down_proj.weight", ("model", "layer", None)
          ),
          ...
          "base.decoder.layers.DeepSeekMoeBlock_0.shared_experts.wi_0.kernel": (
              "layers.*.shared_experts.kernel_gating_DF", (None, "layer", "model")
          ),
          "base.decoder.layers.DeepSeekMoeBlock_0.shared_experts.wi_1.kernel": (
              "layers.*.shared_experts.kernel_up_proj_DF", (None, "layer", "model")
          ),
          "base.decoder.layers.DeepSeekMoeBlock_0.shared_experts.wo.kernel": (
              "layers.*.shared_experts.kernel_down_proj_FD", ("model", "layer", None)
          ),
          # Router
          "base.decoder.layers.DeepSeekMoeBlock_0.MoeBlock_0.gate.kernel": (
              "layers.*.custom_module.router.kernel_DE", (None, "layer", "model")
          ),
          "base.decoder.layers.DeepSeekMoeBlock_0.MoeBlock_0.gate.bias": (
              "layers.*.custom_module.router.bias_E", (None, "layer", "model")
          ),
          # Routed Experts (Fused)
          "base.decoder.layers.DeepSeekMoeBlock_0.MoeBlock_0.wi_0": (
              "layers.*.custom_module.kernel_gating_EDF", ("expert", "layer", None, "model")
          ),
          "base.decoder.layers.DeepSeekMoeBlock_0.MoeBlock_0.wi_1": (
              "layers.*.custom_module.kernel_up_proj_EDF", ("expert", "layer", None, "model")
          ),
          "base.decoder.layers.DeepSeekMoeBlock_0.MoeBlock_0.wo": (
              "layers.*.custom_module.kernel_down_proj_EFD", ("expert", "layer", "model", None)
          ),

          # ==============================================================================
          # MTP BLOCK (Included for completeness, but typically skipped by current loader)
          # ==============================================================================
          "base.mtp_block.mtp_layer_1.embedding_norm.scale": (
              "mtp_block.layer.pre_norm.scale", (None,)
          ),
          "base.mtp_block.mtp_layer_1.hidden_state_norm.scale": (
              "mtp_block.layer.post_norm.scale", (None,)
          ),
          "base.mtp_block.mtp_layer_1.projection_layer.kernel": (
              "mtp_block.layer.projection.kernel", (None, "model")
          ),
          # Note: MTP transformer layer mappings follow the same pattern as base layers
          # but prefixed with `base.mtp_block.mtp_layer_1.transformer_layer.`
          # Users can copy the MLA/MoE patterns above if MTP support is added to loader.
      }
      return mapping