...
"""Shim for JAX implementation without using Pallas for Flash Attention."""

import sys
import importlib
from MaxText import max_logging

OLD_MODULE_PATH = "MaxText.kernels.jax_flash_attention"
NEW_MODULE_PATH = "maxtext.kernels.jax_flash_attention"
