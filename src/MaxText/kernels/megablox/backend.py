...
"""Shim for Grouped matrix multiplication kernels for TPU written in Pallas."""

import sys
import importlib
from MaxText import max_logging

OLD_MODULE_PATH = "MaxText.kernels.megablox.backend"
NEW_MODULE_PATH = "maxtext.kernels.megablox.backend"
