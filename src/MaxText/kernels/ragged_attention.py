...
"""Shim for Kernels for ragged attention for efficient inference."""

import sys
import importlib
from MaxText import max_logging

OLD_MODULE_PATH = "MaxText.kernels.ragged_attention"
NEW_MODULE_PATH = "maxtext.kernels.ragged_attention"
