...
def read_replicator_error_file(error_file: str):
  ...
  try:
    ...
    max_logging.log(f"replicator_error_handler: Failed to read contents of failed file: {e}")
...
def cleanup_replicator_error_file(error_file: str):
  ...
  try:
    ...
    max_logging.log(f"replicator_error_handler: Failed to remove replicator errors file: {e}")
  ...
  if checkpoint_manager is not None:
    ...
    if step is not None:
      ...
      match (checkpoint_manager, dataset_type, data_iterator):
        ...
        case (checkpoint_manager, dataset_type, data_iterator) if (
          dataset_type == "grain" and data_iterator and (checkpoint_manager.directory / str(step) / "iter").exists()
        ):
