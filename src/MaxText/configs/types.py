...
class VLLM(BaseModel):
  ...
  max_num_batched_tokens: int = Field(2048, description="Max number of batched tokens in vLLM.")
  max_num_seqs: int = Field(256, description="Max number of sequences in vLLM.")
