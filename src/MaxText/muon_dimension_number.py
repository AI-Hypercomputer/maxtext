...
def transform_logic(x, path):
  """
  assume scan, should work with unscan. 
  ...
  # [0, L, -2, -1], yellow
    ...
    return mdn((0, -2), (-1,))
  # [0, L, -2, -1], yellow, query for ds2, wq_b for ds3
  elif "self_attention" in path and (
      "wkv_b" in path or "query" in path or "wq_b" in path or "key" in path or "value" in path
  ):
    return mdn((0,), (-2, -1))
  # gray, do not apply muon: scalar, bias, embedding, unembedding
