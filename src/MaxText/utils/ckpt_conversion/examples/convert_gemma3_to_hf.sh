...
HF_CHECKPOINT_GCS_PATH="gs://src/MaxText-model-checkpoints/HuggingFace/gemma3-4b/${DATE}" # (optional)GCS path for HF model
MAXTEXT_CHECKPOINT_DIR="gs://src/MaxText-model-checkpoints/gemma3-4b/2025-03-18-19-03/unscanned/checkpoints/0/items"
