...
#   export QUANT_PATH="/home/${USER}/src/MaxText/MaxText/configs/quantization/${QUANT_MP}.json"
fi
...
if [[ -z ${TOKENIZER_PATH} ]] ; then
  export TOKENIZER_PATH="${MAXTEXT_ASSETS_ROOT:-${MAXTEXT_REPO_ROOT:-$PWD}/assets}/tokenizer.llama2" # NOTE: you may need to change this path for your VM
fi
