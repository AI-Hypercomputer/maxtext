...
def calculate_mtp_loss(intermediate_outputs, config):
  ...
  mtp_losses = src/MaxText_utils.get_nested_value(intermediate_outputs, losses_path, default=())
  mtp_weights = src/MaxText_utils.get_nested_value(intermediate_outputs, weights_path, default=())
...
def calculate_mtp_acceptance_rate(intermediate_outputs, config):
  ...
  sown_data = src/MaxText_utils.get_nested_value(intermediate_outputs, ("mtp_acceptance", "mtp_block"), {})
  mtp_preds = src/MaxText_utils.get_nested_value(sown_data, ("mtp_preds",), [None])[0]
  valid_mask = src/MaxText_utils.get_nested_value(sown_data, ("mtp_mask",), [None])[0]
