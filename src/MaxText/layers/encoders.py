...
class VisionEncoder(nn.Module):
  ...
  def get_vision_encoder_layers(self):
    ...
    if self.config.model_name in ["gemma3-4b", "gemma3-12b", "gemma3-27b"]:
      from maxtext.src.maxtext.layers import gemma3  # pylint: disable=import-outside-toplevel
      ...
      from maxtext.src.maxtext.layers import llama4  # pylint: disable=import-outside-toplevel
