...
from maxtext.src.maxtext.common_types import MODEL_MODE_PREFILL, DecoderBlockType, Config, MODEL_MODE_TRAIN, MODEL_MODE_AUTOREGRESSIVE, DECODING_ACTIVE_SEQUENCE_INDICATOR
from maxtext.src.maxtext.inference import page_manager
from maxtext.src.maxtext import multimodal_utils
from maxtext.src.maxtext.layers import nnx_wrappers
from maxtext.src.maxtext.layers.decoders import Decoder
from maxtext.src.maxtext.layers.embeddings import Embed, embed_as_linen
from maxtext.src.maxtext.layers.encoders import VisionEncoder
from maxtext.src.maxtext.layers.quantizations import AqtQuantization as Quant
from maxtext.src.maxtext.layers.multi_token_prediction import MultiTokenPredictionBlock
from maxtext.src.maxtext.maxtext_utils import all_gather_over_fsdp
