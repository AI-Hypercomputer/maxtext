...
class Pipeline(nn.Module):
  ...
  def init_states(self, inputs):
    ...
    if self.config.pipeline_delay_activation_forwarding:
      ...
      prev_outputs = self._maybe_shard_with_logical(prev_outputs, self.stages_in_logical, sharding_desc="pipeline/prev_outputs")
    else:
      prev_outputs = None
  ...
  def get_iteration_inputs(self, loop_iteration, state_io, circ_storage, shift):
    ...
    first_stage_in = self._maybe_shard_with_logical(first_stage_in, self.stages_in_logical, sharding_desc="pipeline/first_stage_in")
