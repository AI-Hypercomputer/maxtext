...
class MLA(Attention):
  ...
  def __call__(
    ...
    """
    if model_mode == MODEL_MODE_PREFILL:
      inputs_q = self._maybe_shard_with_logical(inputs_q, self.prefill_input_axis_names, sharding_desc="attention_mla/input_q")
      inputs_kv = self._maybe_shard_with_logical(inputs_kv, self.prefill_input_axis_names, sharding_desc="attention_mla/inputs_kv")
      ...
      inputs_kv = self._maybe_shard_with_logical(inputs_kv, self.ep_input_axis_names, sharding_desc="attention_mla/inputs_kv")
      ...
      inputs_kv = self._maybe_shard_with_logical(inputs_kv, self.input_axis_names, sharding_desc="attention_mla/inputs_kv")
