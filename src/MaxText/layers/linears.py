...
from maxtext.src.maxtext.common_types import MODEL_MODE_PREFILL, DecoderBlockType, DType, Array, Config
from maxtext.src.maxtext.layers import nnx_wrappers, quantizations
from maxtext.src.maxtext.layers import normalizations
from maxtext.src.maxtext.layers.initializers import NdInitializer, nd_dense_init, default_bias_init, variable_to_logically_partitioned
...
class MlpBlock(nnx.Module):
  ...
  def get_norm_layer(self, num_features: int):
    ...
    if self.config.decoder_block in (
      ...
      from maxtext.src.maxtext.layers import gpt3  # pylint: disable=import-outside-toplevel
