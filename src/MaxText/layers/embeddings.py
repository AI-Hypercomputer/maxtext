...
class Embed(nnx.Module):
  ...
  def __call__(self, inputs: Array, model_mode: str = MODEL_MODE_TRAIN) -> Array:
    ...
    out_sharding = NamedSharding(self.mesh, out_pspec) if self.config.shard_mode == "explicit" else None
  ...
  def attend(self, query: Array, out_sharding: NamedSharding = None) -> Array:
