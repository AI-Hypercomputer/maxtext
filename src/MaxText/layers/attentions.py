...
class Attention(nnx.Module):
  ...
  def __init__(
    ...
    self.isQwen3Next = self.config.decoder_block == DecoderBlockType.QWEN3_NEXT
  ...
  def __call__(
    ...
    if (self.use_qk_norm and not is_llama4_decoder_block) or self.isQwen3Next:
