...
def fix_latex_escaping(text: str) -> str:
    ...
    latex_commands = [
        ...
        'sum', 'int', 'infty', 'cdot', 'times', 'div', 'pm', 'mp',
        'leq', 'geq', 'neq', 'approx', 'equiv', 'sin', 'cos', 'tan',
        'log', 'ln', 'exp', 'lim', 'to', 'rightarrow', 'leftarrow',
        'Rightarrow', 'Leftarrow', 'overline', 'underline', 'hat', 'bar',
