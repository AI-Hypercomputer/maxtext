...
echo "1. Creating workload via xpk (this builds & uploads container image)..."
...
echo "2. Deleting un-schedulable base workload from cluster..."
kubectl delete jobset "${WORKLOAD_NAME}" -n default --ignore-not-found

echo "3. Patching manifest with GKE reservation details & compute-class tolerations..."
...
echo "4. Submitting patched workload to cluster..."
