...
For each of the TPU platforms listed below, we present a list of optimized models[^1] for pre-training. If you’re getting started with MaxText, or want to push performance, we recommend choosing a Gold model, with an accompanying pre-training recipe.
