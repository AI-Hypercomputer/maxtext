...
This metric helps determine whether a computation is CPU-bound (high arithmetic intensity) or memory-bound/communication-bound (low arithmetic intensity).
...
This can be set via `LIBTPU_INIT_ARGS`. For example:
