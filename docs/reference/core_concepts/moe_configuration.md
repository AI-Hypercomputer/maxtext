...
- Uses Tokamax v1 for all passes: `use_gmm_v2=false` or `[false,false,false]`.
- Uses Tokamax v2 for all passes: `use_gmm_v2=true` or `[true,true,true]`.
- Uses a mixed backend: `use_gmm_v2=[true,false,true]` (v2 for Fwd, v1 for DLHS, v2 for DRHS).
