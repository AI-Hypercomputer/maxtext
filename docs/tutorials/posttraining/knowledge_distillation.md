...
#### b. Install dependencies
 ...
 To install MaxText and its dependencies, follow the instructions in the [Install Maxtext](https://maxtext.readthedocs.io/en/latest/install_maxtext.html#install-maxtext) documentation.
