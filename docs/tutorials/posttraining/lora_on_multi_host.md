...
- A GKE cluster configured for Cluster Toolkit, including healthy Kueue and JobSet components (see [Cluster Toolkit documentation](https://cloud.google.com/cluster-toolkit/docs/overview)).
...
export CHAT_TEMPLATE_PATH=<CHAT_TEMPLATE_PATH> # e.g., src/maxtext/examples/chat_templates/gemma_chat.json
