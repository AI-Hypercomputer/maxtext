...
`distill_layer_indices` selects which scanned-layer slices contribute to `feature_loss`. The legacy XPK launcher's default is `[0,1,2,...,7]` — the first 8 layers, irrespective of model depth. Better defaults usually exist:
