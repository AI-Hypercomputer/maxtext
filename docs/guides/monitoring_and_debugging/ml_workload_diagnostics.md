...
Users can deploy the workload across all supported environments, including the recommended Cluster Toolkit workflow (`gcluster job submit`) or by running the workload directly on a standalone TPU VM.
