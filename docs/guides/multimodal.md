...
For the Llama4 model family, we are using a separate checkpoint conversion script (Of note,we will gradually migrate the checkpoint conversion scripts to the above consolidated tool soon):
...
The decoding results will be looking like this:
```
