...
2. In [`MaxText/configs/base.yml`](https://github.com/AI-Hypercomputer/maxtext/blob/main/MaxText/configs/base.yml) or through command line, set the following parameters:
