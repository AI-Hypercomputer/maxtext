...
export MAXTEXT_CKPT_PATH="${MAXTEXT_CKPT_PATH:-gs://maxtext-model-checkpoints/qwen3-0.6b/2025-10-27/scanned/0/items}" # GCS path of the MaxText checkpoint to fine-tune from
