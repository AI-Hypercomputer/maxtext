...
# This script converts a qwen3-30b-a3b-base model checkpoint from the Hugging Face
...
CONVERTED_CKPT_BASE_DIR="${BASE_OUTPUT_DIRECTORY}/checkpoints/qwen3-30b-a3b-base-converted"
