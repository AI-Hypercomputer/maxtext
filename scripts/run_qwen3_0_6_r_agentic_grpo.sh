...
# Qwen3-0.6B model on a GKE cluster using XPK, configured with AgenticGRPOLearner.
# Note: continue_decode has been disabled because AgenticGRPOLearner requires
# log-probabilities from the rollout responses, which continue_decode drops.
