...
# In SPMD DiLoCo for 36 decoder layers: num_fragments = 37 (1 non-layer + 36 layer frags)
...
# 1. Build and push image from /usr/local/google/home/jzuo/maxtext
echo "Building docker image for SPMD DiLoCo from /usr/local/google/home/jzuo/maxtext..."
docker build -t "${MY_IMAGE}" -f - /usr/local/google/home/jzuo/maxtext <<INNER_EOF
...
# 2. Create workload using standard multi-slice xpk
echo "Creating SPMD workload: ${RUNNAME}"
...
echo "SPMD Workload ${RUNNAME} created successfully."
