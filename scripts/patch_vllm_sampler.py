...
# call_pattern = r"  def __call__\([^)]+\)\s*(?:->[^:]+)?:\n"
# call_match = re.search(call_pattern, c)
# if call_match:
#     print("Skipped max_generation_steps override.")
#     print("Hotfix (max_generation_steps override) already applied.")
# else:
#   print("Warning: target __call__ signature not found.")
