...
class SFTDataProcessingTest(unittest.TestCase):
  ...
  def test_sft_format_with_messages(self):
    ...
    truncated_exp1_inputs = ("<s> <user>example one question one</user> <assistant>example one answer one</assistant> "
                             "<user>example one question two</user> <assistant>example one answer two</assistant")
    truncated_exp1_targets = ("<unk><unk><unk><unk><unk><unk><unk><unk><unk><unk> <assistant>example one answer one"
                              "</assistant><unk><unk><unk><unk><unk><unk><unk><unk><unk><unk> <assistant>example one "
                              "answer two</assistant<unk>")
    truncated_exp1_targets_predictable = ("<unk><unk><unk><unk><unk><unk><unk><unk><unk><unk> <assistant>example one "
                                          "answer one</assistant><unk><unk><unk><unk><unk><unk><unk><unk><unk><unk> "
                                          "<assistant>example one answer two</assistant<unk>")

    # exp2 is packed from 2nd and 3rd entries, testing packing
    packed_exp2_inputs = ("<s> <user>question two</user> <assistant>answer two</assistant></s><s> <user>question three"
                          "</user> <assistant>answer three</assistant></s><unk><unk><unk><unk>")
    packed_exp2_targets = ("<unk><unk><unk><unk><unk><unk><unk><unk> <assistant>answer two</assistant></s><s><unk><unk>"
                           "<unk><unk><unk><unk><unk><unk> <assistant>answer three</assistant></s><unk><unk><unk><unk>"
                           "<unk>")
    packed_exp2_targets_predictable = ("<unk><unk><unk><unk><unk><unk><unk><unk> <assistant>answer two</assistant></s>"
                                       "<unk><unk><unk><unk><unk><unk><unk><unk><unk> <assistant>answer three"
                                       "</assistant></s><unk><unk><unk><unk><unk>")
