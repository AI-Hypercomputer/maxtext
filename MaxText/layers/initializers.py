...
default_embed_init = nn.initializers.constant(-7)
...
def nd_dense_init(scale, mode, distribution):
  ...
  def init_fn(key, shape, dtype, in_axis, out_axis):
    fn = nn.initializers.constant(-7)
    # jax.nn.initializers.variance_scaling(scale, mode, distribution, in_axis, out_axis)
