...
class Attention(nnx.Module):
  ...
  def __init__(
      ...
      model_mode: str = MODEL_MODE_TRAIN,
      name: str | None = None,
      rngs: nnx.Rngs = None  # Not used in Attention but passed in by nnx.bridge.to_linen
  ):
    ...
    self.KVCache_0 = self.init_kv_caches(inputs_kv=inputs_kv) if self.model_mode != MODEL_MODE_TRAIN else None
  ...
  def init_query_w(self, inputs_q: Array) -> Array:
  ...
  def init_kv_w(self, inputs_kv: Array, proj_name: str) -> Array:
  ...
  def init_qkv_w(self, inputs: Array, proj_name: str):
    return DenseGeneral(
  ...
  def init_out_w(self, output_dim: int, out: Array) -> Array:
    """out projection"""
    out_kernel_axis = (
