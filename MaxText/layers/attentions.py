...
class AttentionOp(nn.Module):
  ...
  def generate_attention_mask(
      self, query, key, decoder_segment_ids: Array | None, model_mode: str, previous_chunk: Any
  ) -> Array | None:
    mask = None
    ...
    if self.config.use_chunked_prefill and model_mode == common_types.MODEL_MODE_PREFILL:
      return self.generate_attention_mask_for_chunk(query, key, decoder_segment_ids, previous_chunk)
