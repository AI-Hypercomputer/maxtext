...
def unquantize_kv(value: Array, scale: Array, dtype: jnp.dtype, scale_shape: Optional[AxisIdxes] = None):
  """Unquantize key/values stored in kvcache."""
  if scale_shape is not None:
    scale = jnp.broadcast_to(scale, scale_shape)
