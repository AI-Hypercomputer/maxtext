...
class Pipeline(nn.Module):
  ...
  def __call__(
    ...
    # remat_policy = jax.checkpoint_policies.save_from_both_policies(
    #       jax.checkpoint_policies.nothing_saveable, jax.checkpoint_policies.save_only_these_names("iteration_input")
    #   )
    # remat_policy = jax.checkpoint_policies.save_only_these_names("iteration_input", "decoder_layer_input")
