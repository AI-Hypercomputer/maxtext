...
class Transformer(nn.Module):
  ...
  def setup(self):
    ...
    if self.config.attention == "paged":
      assert self.config.max_target_length % self.config.pagedattn_tokens_per_page == 0
      assert self.config.max_prefill_predict_length % self.config.pagedattn_tokens_per_page == 0
