...
def create_engine_from_config_flags(batch_size, max_prefill_predict_length, max_target_length):
  import copy
  import pyconfig
  args_str = "MaxText/maxengine_server.py configs/v5e/inference/llama2_70b_v5e-16.yml"
  ...
  args.append("load_parameters_path=gs://morgandu-tpu/checkpoints/quantized/aqt/llama2-70b-chat")
  args.append("quantization=int8")
  args.append("quantize_kvcache=False")
