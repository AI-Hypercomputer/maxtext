...
# gcs_jsonl_file = 'gs://mazumdera-test-bucket/lg/jsonl-data/00-0-0.jsonl'
# tfrecord_file = 'gs://mazumdera-test-bucket/lg/tfrecord-data/00-0-0.tfrecord' 

gcs_jsonl_bucket = 'mazumdera-test-bucket'
prefix = 'lg/jsonl-data'
tfrecord_path = 'gs://'+gcs_jsonl_bucket+'/lg/tfrecord-data/' 
