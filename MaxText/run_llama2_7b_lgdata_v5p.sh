...
BUCKET_NAME=mazumdera-test-bucket-us-east5
LEARNING_RATE=1e-4
STEPS=145001
...
dataset_path=gs://mazumdera-test-bucket/lg/jsonl-data-complete1 \
steps=${STEPS} \
dataset_name=json \
dataset_dir=None \
dataset_files=/tmp/gcsfuse/lg/jsonl-data-complete1/*.jsonl \
eval_dataset_name='' \
eval_split='' \
dataset_type=hf \
