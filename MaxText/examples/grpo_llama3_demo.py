...
LOG_DIR = f"{HOME}/logs/tensorboard/grpo/logs_llama3/"
if not os.path.exists(LOG_DIR):
  os.makedirs(LOG_DIR)

# ===== Profiling =====
PROFILE_DIR = f"{HOME}/profile/jax_traces/grpo/profiles_llama3/"
if not os.path.exists(PROFILE_DIR):
  os.makedirs(PROFILE_DIR)

# ====== Checkpoint saving ======
CKPT_DIR = f"{HOME}/checkpoints/ckpts_llama3/"
...
def get_dataset(data_dir, split="train") -> grain.MapDataset:
  """Loads the GSM8K dataset from TFDS and preprocesses it."""
  # Download data
