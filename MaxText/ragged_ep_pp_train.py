...
# For DeepSeek layer_string = moe_layers, for other models it is simply layers
layer_string = 'moe_layers' # moe_layers for deepseek, layers otherwise

dp_params_copy['params']['decoder'][layer_string] = dp_module_subtree
...
dp_layer_grads = dp_rp_grads['params']['decoder'][layer_string]
...
print("Asserting grads computed via PP or DP are close...", flush=True)
assert_allclose(pp_layer_grads, dp_layer_grads, atol=1e-3,  equal_nan=False)
