...
def grpo_loss_fn(model, config, data, dropout_rng, params, reference_params, is_train=True):
  ...
  This function performs the following steps:
    ...
    1. Compute the per-token log-probabilities for the full sequence (prompt + completion) both with the
    ...
    6. Compute a scalar reward for each generated completion via reward_fn.
