...
*   **inference_rollouts:** The frequency in training steps to reshard and copy training parameters to the inference mesh. Must be an integer between 1 and `steps`.
