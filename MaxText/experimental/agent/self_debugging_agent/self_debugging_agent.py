...
from utils import save_in_file_and_check_code_syntax, parse_json_response, smartly_copy_code
from prompt_debugging import CodeDebugging
...
parser.add_argument("--module_name", type=str, nargs="+", help="Name of the module in case want to check one case only.")
parser.add_argument(
    "--pytorch_path",
    type=str,
...
parser.add_argument(
    "--jax_path", type=str, default="./dataset/jax_converted/", help="Path to the directory containing JAX files."
)
parser.add_argument(
    "--testcase_path",
    type=str,
    default="./dataset/test_cases/",
...
def make_code_and_debug(python_file, jax_file):
  ...
  try:
    ...
    # logger.error("The jax Code is %s", jax_code)
    # logger.error("The testcase Code is %s", test_case_code)
