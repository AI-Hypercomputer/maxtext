...
def create_device_mesh(config, logging=True):
  ...
  dcn_parallelism = [config.dcn_data_parallelism, config.dcn_fsdp_parallelism, config.dcn_sequence_parallelism, config.dcn_tensor_parallelism]
  ici_parallelism = [config.ici_data_parallelism, config.ici_fsdp_parallelism, config.ici_sequence_parallelism, config.ici_tensor_parallelism]
