...
"""Small-sized model with 4-bit quantization for attention weights only."""
...
def get_config():
  """Returns configuration for a small transformer model with 4-bit quantization for attention weights only."""
  ...
  config.metadata.hyper_str = "attn_weights_quant_4bit"
  return config
