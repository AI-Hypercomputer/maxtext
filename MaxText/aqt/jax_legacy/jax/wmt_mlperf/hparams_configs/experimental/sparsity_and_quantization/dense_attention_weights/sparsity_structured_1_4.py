...
"""Small-sized model with 1:4 sparsity for attention weights only."""
...
def get_config():
  """Returns configuration for a small transformer model with 1:4 sparsity for attention weights only."""
  ...
  config.metadata.hyper_str = 'attn_weights_sparsity_structured_1_4'
  return config
