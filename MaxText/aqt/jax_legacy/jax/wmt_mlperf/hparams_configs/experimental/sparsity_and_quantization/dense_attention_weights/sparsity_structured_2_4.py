...
"""Small-sized model with 2:4 sparsity for attention weights only."""
...
def get_config():
  """Returns configuration for a small transformer model with 2:4 sparsity for attention weights only."""
  config = small_model_bfloat16.get_config(
      quant_target=base_config.QuantTarget.NONE)
  ...
  config.metadata.hyper_str = 'attn_weights_sparsity_structured_2_4'
  return config
