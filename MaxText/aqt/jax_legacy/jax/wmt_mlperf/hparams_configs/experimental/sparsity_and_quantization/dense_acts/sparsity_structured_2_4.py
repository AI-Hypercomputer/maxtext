...
"""Small-sized model with 2:4 sparsity for dense activations only."""
...
def get_config(quant_target=base_config.QuantTarget.NONE):
  """Returns configuration for a small transformer model with 2:4 sparsity for dense activations only."""
  ...
  config.metadata.hyper_str = 'mlp_acts_sparsity_structured_2_4'
  return config
