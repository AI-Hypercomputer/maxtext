...
"""Small-sized model with 1:4 sparsity for weights only."""
...
def get_config(quant_target=base_config.QuantTarget.NONE):
  """Returns configuration for a small transformer model with 1:4 sparsity for weights only."""
  ...
  config.metadata.hyper_str = 'mlp_weights_sparsity_structured_1_4'
  return config
