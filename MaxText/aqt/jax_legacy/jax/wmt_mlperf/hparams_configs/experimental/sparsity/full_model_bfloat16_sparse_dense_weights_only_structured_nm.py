...
def get_config(n, m, quant_target=base_config.QuantTarget.NONE):
  """Applies structured N:M sparsity on dense layers."""
  config = base_config.get_config(n_layers=6, quant_target=quant_target)
  config.metadata.hyper_str = 'full_bfloat16_structured_weights_dense_nm'
  config.mlp_block.dense_1.weight_sparsity.prune_rate = (n, m)
  config.mlp_block.dense_1.weight_sparsity.type = 'STRUCTURED_NM'
  config.mlp_block.dense_2.weight_sparsity.prune_rate = (n, m)
