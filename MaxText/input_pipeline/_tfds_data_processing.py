...
def get_datasets(
  ...
  if ds_builder.info.splits[data_split].num_shards >= dataloading_host_count:
    ...
    warnings.warn(
        f"WARNING: Inefficient dataloading. {dataset_name} contains {ds_builder.info.splits[data_split].num_shards}"
        f" shards, smaller than {dataloading_host_count=}. This is known to lead to inefficient dataloading. See"
