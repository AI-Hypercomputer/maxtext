...
def preprocessing_pipeline(
  ...
  if use_sft:
    if len(data_column_names) > 1:
      dataset = dataset.map(_input_pipeline_utils.combine_columns, fn_kwargs={"columns": data_column_names})
      data_column_names = data_column_names[:1]
  ...
  if shift and not use_dpo:
    operations.append(_input_pipeline_utils.ShiftData(bos_id=tokenizer.bos_token_id, unk_id=tokenizer.unk_token_id, axis=1))
