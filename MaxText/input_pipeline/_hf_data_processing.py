...
def make_hf_train_iterator(
  ...
  train_iter = multihost_dataloading.MultiHostDataLoadIterator(train_data_loader, global_mesh, config.logical_axis_rules)
  return train_iter
...
def make_hf_eval_iterator(
  ...
  eval_iter = multihost_dataloading.MultiHostDataLoadIterator(eval_data_loader, global_mesh, config.logical_axis_rules)
  return eval_iter
