...
def make_c4_mlperf_train_iterator(
  ...
  train_multihost_gen = multihost_dataloading.MultiHostDataLoadIterator(train_ds, global_mesh, config.logical_axis_rules)
...
def make_c4_mlperf_eval_iterator(
  ...
  eval_multihost_gen = multihost_dataloading.MultiHostDataLoadIterator(eval_ds, global_mesh, config.logical_axis_rules)
