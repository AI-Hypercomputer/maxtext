...
class _HyperParameters():
  ...
  def user_init(raw_keys):
    ...
    assert (raw_keys["load_parameters_path"]=="" and raw_keys["load_from_other_directory"]=="") or raw_keys["enable_checkpointing"], "You must set enable_checkpointing to load a checkpoint"
