...
def set_and_validate_pipeline_config(raw_keys):
  if using_pipeline_parallelism(raw_keys):
    ...
    if raw_keys["pipeline_parallel_layers"] < raw_keys["num_decoder_layers"]:
      assert raw_keys["scan_layers"], "Currently we only support scan_layers=True when pipelining a subset of layers."
