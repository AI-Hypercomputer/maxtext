...
def reshard(
    ...
    *,
    ...
    put_array: (
        Callable[[jax.Array, jax.sharding.Sharding, bool, bool], jax.Array]
        | None
    ) = None,
) -> Any:
  ...
  Args:
      ...
      donate: If `True`, donates the input arrays to reduce memory needed
  ...
  return jax.tree.map(lambda arr, sharding: put_array(arr, sharding, donate, may_alias), x, sharding)
