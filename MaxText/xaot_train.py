...
def train_loop(config, state=None):
  ...
  devices_array = max_utils.create_device_mesh(config, jax.devices()) # alter
  ...
  if config.save_xaot:
    ...
    func_input_args, func_input_kwargs, state_shape = max_utils.get_shaped_inputs(model, tx, config, init_rng, topology_mesh, data_iterator)
    state_mesh_annotations = max_utils.get_state_mesh_annotations(state_shape, topology_mesh, config) #refactor into lower?
