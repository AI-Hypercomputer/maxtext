"""Test script for paged attention infrastructure."""
import os
...
if __name__ == "__main__":
    # Examples of running:
    # 1. Use all defaults:
    #    python3 test_paged_attention.py MaxText/configs/base.yml
    # 2. Override some values:
    #    python3 test_paged_attention.py MaxText/configs/base.yml num_pages=16 tokens_per_page=32
    app.run(main)