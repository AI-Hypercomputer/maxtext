...
def main(args: Sequence[str]):
    ...
    MAPS = {
        ...
        ".params['decoder']['decoder']['mlp']['mlp_layer_norm']['scale']": ("mdl_vars.params.lm.transformer.repeat.sub.x_layers_0.ff_layer.layer_norm.scale", lambda x: np.moveaxis(x, 0, cfg.param_scan_axis) + 1.),
        ...
        ".params['decoder']['decoder_norm']['scale']": ("mdl_vars.params.lm.final_ln.scale", lambda x: x.T + 1.),
