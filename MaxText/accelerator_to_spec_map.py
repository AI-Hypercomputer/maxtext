...
class SystemCharacteristics:
  ...
  wrap: Optional[tuple]  # wrap around for each dimension (locus type in go/borg-tpus)


UserFacingNameToSystemCharacteristics = {
    # v6e: one core per chip with 32 GB HBM
    "v6e-1": SystemCharacteristics("tpu", "v6e:1x1", "default", (2, 2, 1), 1, (False, False, False)),
