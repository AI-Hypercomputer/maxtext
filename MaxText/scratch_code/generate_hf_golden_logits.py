...
python3 MaxText/scratch_code/generate_hf_golden_logits.py --model-id=deepseek-ai/DeepSeek-V2-Lite 
--output-path=golden_DeepSeek-V2-Lite.jsonl --prompts='I love to,Today is a,What is the', --gcs_bucket=my-gcs-bucket
...
def main(raw_args=None) -> None:
  ...
  parser.add_argument("--gcs-bucket", type=str, required=False, default=None, help="A GCS bucket to store logits, without gs://.")
