...
class GRPOTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.state, state_mesh_annotations = maxtext_state_initialization_utils.setup_decode_state(self.model, self.cfg, self.rng, mesh, None)
    ...
    self.state_no_ckpt_loading, _ = maxtext_state_initialization_utils.setup_decode_state(
