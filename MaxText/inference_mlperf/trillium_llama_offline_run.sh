...
dry_run=true
accuracy=false
enable_batch_prefill=true #falseß
performance=true
audit=false
enable_profiler=false
test_run=false

export PREFILL_LENS_AND_PER_DEVICE_BATCH_SIZES="1024,64"
#export PREFILL_LENS_AND_PER_DEVICE_BATCH_SIZES="1024,60"
#export PREFILL_LENS_AND_PER_DEVICE_BATCH_SIZES="256,240|512,120|1024,60"
shopt -s extglob
PB_STR=${PREFILL_LENS_AND_PER_DEVICE_BATCH_SIZES//+([,|])/_}
KV="int4"
run_name="trillium_${PB_STR}_${KV}_pack_${enable_batch_prefill}"
