...
export LOAD_PARAMETERS_PATH=gs://inference-benchmarks/models/llama2-70b-chat/quant/int8_/
export MAX_PREFILL_PREDICT_LENGTH=512
...
MaxText/configs/base.yml   tokenizer_path=${TOKENIZER_PATH}   \
...
inference_microbenchmark_prefill_lengths="512" checkpoint_is_quantized=True \
attention=flash base_output_directory="gs://jacobplatin/profiles/flash_attention_testing/llama2-70b-v6e-8-script-run-512-1024-1024-block-sizes/" run_name=flash_attention \
