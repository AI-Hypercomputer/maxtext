...
echo
export TOKENIZER_PATH=/home/${USER}/github/maxtext/assets/tokenizer_llama3.tiktoken
if "$unquantized"; then
    export LOAD_PARAMETERS_PATH=gs://wyzhang-dev/ckpt/maxtext/llama-3.1-8b/unscanned/checkpoints/0/items
    export QUANTIZATION=" "
...
quantization=${QUANTIZATION} quantize_kvcache=${QUANTIZE_KVCACHE} inference_microbenchmark_stages=${stages} \
