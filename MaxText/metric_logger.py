...
class MetricLogger:
  ...
  def record_eval_metrics(self, step, metrics=None, eval_step_count=None, eval_step_time_delta=None):
    ...
    if eval_step_count:
      self.cumulative_eval_metrics["scalar"]["eval/step_time_seconds"] = eval_step_time_delta.total_seconds()
