...
# Train
export LIBTPU_INIT_ARGS="--xla_tpu_scoped_vmem_limit_kib=122880 --xla_tpu_assign_all_reduce_scatter_layout=true --xla_tpu_relayout_group_size_threshold_for_reduce_scatter=1 --xla_tpu_use_minor_sharding_for_major_trivial_input=true --xla_enable_async_all_gather=true --xla_tpu_overlap_compute_collective_tc=true --xla_tpu_enable_async_collective_fusion_multiple_steps=true --xla_tpu_enable_async_collective_fusion=true --xla_tpu_enable_async_collective_fusion_fuse_all_gather=true"
