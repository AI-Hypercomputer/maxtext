...
python3 MaxText/$SCRIPT MaxText/configs/base.yml run_name=$RUN_NAME\
    steps=$STEPS checkpoint_period=1 per_device_batch_size=6 enable_checkpointing=true async_checkpointing=false\
    ...
    load_full_state_path=$PREVIOUS_STATE mode=$MODE
