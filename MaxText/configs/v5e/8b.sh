...
# bash MaxText/configs/v5e/8b.sh RUN_NAME="<your_run_name>" OUTPUT_PATH="gs://<your_output_path>" DATASET_PATH="gs://<your_dataset_path>" PLATFORM="gke"
#
...
python3 MaxText/$EXECUTABLE MaxText/configs/base.yml\
    ...
    remat_policy=full global_parameter_scale=8\
