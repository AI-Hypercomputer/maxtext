...
python3 MaxText/train.py MaxText/configs/base.yml run_name=${RUN_NAME}\
    steps=5 per_device_batch_size=1 enable_checkpointing=false\
    enable_profiler=true remat_policy=full base_emb_dim=1024 base_mlp_dim=1024\
    base_num_heads=24 base_num_decoder_layers=36 head_dim=256\
    max_target_length=1024 metrics_file='metrics.txt' log_period=8