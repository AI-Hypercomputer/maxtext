...
# bash MaxText/configs/experimental/512b.sh
...
python3 MaxText/train.py MaxText/configs/base.yml run_name=$RUN_NAME\
    ...
    dataset_type=synthetic gcs_metrics=true enable_flash_attention=true int8_training=true
