...
command="python3 MaxText/train.py MaxText/configs/base.yml \
    ...
    save_period=60000 enable_dropout=false run_name=${run_name}\
    base_output_directory=gs://maxtext-experiments-multipod\
    dataset_path=gs://max-datasets-rogue\
    use_int8_training=${int8}\
    remat_policy=full init_weights_seed=${init_key}\
    global_parameter_scale=${scale}
    load_from_other_directory=gs://maxtext-experiments-multipod/mattdavidow-sweep5-a7-lr1_int8T_size32_pods8_key1/checkpoints"
