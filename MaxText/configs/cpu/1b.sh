...
# bash MaxText/configs/cpu/1b.sh RUN_NAME="<your_run_name>" OUTPUT_PATH="gs://<your_output_path>" DATASET_PATH="gs://<your_dataset_path>"
...
python3 MaxText/decode.py MaxText/configs/base.yml run_name=$RUN_NAME\
    ...
    enable_profiler=false global_parameter_scale=1\
