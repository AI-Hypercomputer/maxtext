# Use special libtpu (gs://libtpu_internal/raymondzou/viperlite/2023-09-27-22:32:47-libtpu.so)

echo "Running 128b.sh"
# Example command to invoke this script
# bash MaxText/configs/largest_job/128b_longestjob.sh
...
python3 MaxText/train.py MaxText/configs/base.yml run_name=$RUN_NAME\
    steps=10000 per_device_batch_size=1 enable_checkpointing=false\
    ...
    dataset_type=synthetic log_period=1000 collect_stack_trace=true