...
# bash MaxText/configs/largest_job/128b.sh use_iota_embed=true
...
python3 MaxText/train.py MaxText/configs/base.yml run_name=$RUN_NAME\
    steps=7 per_device_batch_size=0.5 enable_checkpointing=true async_checkpointing=false\
    save_period=5\
    ...
    dataset_path=$DATASET_PATH use_iota_embed=${use_iota_embed} reuse_example_batch=1\
