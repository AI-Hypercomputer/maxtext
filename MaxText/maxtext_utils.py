...
def get_input_data_sharding(mesh, logical_axis_rules):
  data_pspec = P("activation_embed_and_logits_batch", "activation_norm_length")
...
def get_functional_train_with_signature(train_step, mesh, state_mesh_shardings, model, config):
  ...
  data_sharding = get_input_data_sharding(mesh, config.logical_axis_rules)
