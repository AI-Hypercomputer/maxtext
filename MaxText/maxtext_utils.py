...
def get_shaped_batch(config):
  ...
  shaped_batch["['text']_completions"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["['text']_completions_position"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["['text']_completions_segmentation"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["ar_completions_segmentation"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["prompt_completions"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["prompt_completions_position"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["prompt_completions_segmentation"] = jax.ShapeDtypeStruct(batch_shape, jnp.int32)
  shaped_batch["completions_logprobs"] = jax.ShapeDtypeStruct((config.global_batch_size_to_load, config.max_target_length-1), jnp.int32)
