...
source /usr/local/google/home/dipakg/.local/bin/venv/bin/activate
...
export WORKLOAD_NAME="dipakg-qn80b-256e-${TIMESTAMP}"
export DEVICE_TYPE="v6e-256"
export NUM_SLICES=1
export PRIORITY="very-high"
export NUM_STEPS=15
export MAX_RESTARTS=0
export MODEL_NAME="qwen3-next-80b-a3b-256e"
export BASE_OUTPUT_DIR="gs://dipakg-maxtext-logs/qwen3-next-80b-256e-profiles/run-${TIMESTAMP}"

echo "========================================================================"
echo "Building and uploading Docker runner image from /usr/local/google/home/dipakg/.gemini/tmp/google3-3/maxtext_work/maxtext"
echo "Target Image: ${WORKLOAD_IMAGE}"
echo "========================================================================"

(
  cd /usr/local/google/home/dipakg/.gemini/tmp/google3-3/maxtext_work/maxtext && \
