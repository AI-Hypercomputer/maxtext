...
export WORKLOAD_NAME="chengnuojin-qn80b-256e-${TIMESTAMP}"
...
export BASE_OUTPUT_DIR="gs://chengnuojin-maxtext-logs/qwen3-next-80b-256e-profiles/run-${TIMESTAMP}"
...
MAXTEXT_ARGS_ARRAY=(
  ...
  "opt_type=muon"
  "custom_mesh_and_rule=shard-exp-on-fsdp"
