...
# RUNNER = "gcr.io/cloud-tpu-v2-images-dev/shauryag_latest@sha256:0e19ba498516015d0b5d6424ed0227d315d70dbbc6cacf08fdec8dbf979252e5"
      ...
      for cluster_config in [
        ...
        for num_slices in num_slices_list:
          wl_config = mxr.WorkloadConfig(
              ...
              executable="MaxText/elastic_train.py" if infra == "pathways" else "MaxText/train.py",
