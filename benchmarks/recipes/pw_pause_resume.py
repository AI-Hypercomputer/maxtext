...
def main() -> int:
  ...
  # Update
  pathways_config.colocated_python_sidecar_image = None
  pathways_config.server_image = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/lukebaumann/unsanitized_server:latest"
  pathways_config.proxy_server_image = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/lukebaumann/unsanitized_proxy_server:latest"
