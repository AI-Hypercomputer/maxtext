...
RESUME_CHECKPOINT_NAMES = {
    "pathways": {
        32: {
            "run_name":  "sujin-pw-llama3-1--32-022703-f65",
            "base_output_directory": "gs://trillium-scale-tests-q1-25-west/pw_mcjax_benchmarking/sujinesh/20250227_035238_pathways_32_slice_v6e-256_llama3_1-70b-8192-synth/",
            "num_steps": BENCHMARK_STEPS + RESTORE_BENCHMARK_STEPS,
        }
        # 48: "sujin-pw-llama3-1--48-022703-ug0",
    },
    # "mcjax": {
        # 32: "sujin-mcjax-llama3-1--32-022703-f65",
        # 48: "sujin-mcjax-llama3-1--48-022703-ug0",
    # },
}
      ...
      for config in [
        ...
        for num_slices in model_config["num_slices_list"]:
          ...
          if model.pathways_tuning_params is None:
            ...
            # Explicitly enable xplane profiler
            tuning_params["profiler"] = "xplane"
