...
# PROXY_IMAGE = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/wstcliyu/unsanitized_proxy_server:latest"
# SERVER_IMAGE = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/gke/wstcliyu/unsanitized_server:latest"
...
BASE_OUTPUT_DIRECTORY = (
    f"gs://trillium-scale-tests-q1-25-west/pw_mlperf/{USER}/"
)

if USE_GCSFUSE:
  BASE_OUTPUT_DIRECTORY = (
      f"/tmp/gcsfuse/pw_mlperf/{USER}/"
  )
...
def main() -> int:
  ...
  pathways_config = mxr.PathwaysConfig(
    ...
    # Pathways write to this GCS bucket whatever USE_GCSFUSE is
