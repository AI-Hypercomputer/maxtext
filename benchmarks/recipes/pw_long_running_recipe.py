...
PROXY_IMAGE = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/sanitized_proxy_server:latest"
SERVER_IMAGE = "us-docker.pkg.dev/cloud-tpu-v2-images-dev/pathways/sanitized_server:latest"
...
def main() -> int:
  ...
  pathways_config = mxr.PathwaysConfig(
      ...
      runner_image=RUNNER,
      server_flags=(
          "--temporary_flags_for_debugging="
          "temporary_flag_for_debugging_worker_expected_tpu_chip_config="
          "megachip_tccontrol --xla_tpu_use_enhanced_launch_barrier"
      ),
