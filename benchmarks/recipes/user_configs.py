...
USER_CONFIG = UserConfig(
    ...
    benchmark_steps=20,
    num_slices_list=[1],
    server_image="us-docker.pkg.dev/cloud-tpu-v2-images/pathways-colocated-python/server:2025-12-15",
    proxy_image="us-docker.pkg.dev/cloud-tpu-v2-images/pathways-colocated-python/proxy_server:2025-12-15",
