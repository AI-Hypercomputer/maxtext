...
import benchmarks.maxtext_trillium_model_configs as v6e_model_configs
import benchmarks.maxtext_v5p_model_configs as v5p_model_configs
...
def main() -> None:
  ...
  if options.runner == "xpk":
    ...
    models = {
        "v5p-128" : v5p_model_configs.llama2_70b_v5p_128,
        "v5p-256" : v5p_model_configs.llama4_scout_dropless_v5p_256,
        "v5p-512" : v5p_model_configs.deepseek_v3_ep_256_v5p_512,
        "v5p-1024" : v5p_model_configs.deepseek_v3_ep_256_v5p_512,
        "v5p-2048" : v5p_model_configs.deepseek_v3_ep_256_v5p_512,

        "v6e-8" :   v6e_model_configs.llama2_7b_4096,
        "v6e-16" :  v6e_model_configs.llama2_7b_4096,
        "v6e-32" :  v6e_model_configs.llama2_7b_4096,
        "v6e-64" :  v6e_model_configs.llama2_7b_4096,
        "v6e-128" : v6e_model_configs.llama2_70b_4096,
        "v6e-256" : v6e_model_configs.llama2_70b_4096,
    }
