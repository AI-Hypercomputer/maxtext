...
default_basic_1_colocated_python = _add_to_model_dictionary(
    trillium_model_dict,
    MaxTextModel(
        model_name="default-basic-1-colocated-python",
        model_type="default",
        tuning_params={
            # goodput disabled
...
default_basic_1_elastic_train = _add_to_model_dictionary(
    trillium_model_dict,
    MaxTextModel(
        model_name="default-basic-1-elastic",
        model_type="default",
        tuning_params={
            "per_device_batch_size": 1,
            "remat_policy": "full",
...
# [ksadi] rp scale tests config
llama3_1_70b_8192_iter_real_data_and_checkpointing_tfds_remote_python = _add_to_model_dictionary(
    trillium_model_dict,
    MaxTextModel(
