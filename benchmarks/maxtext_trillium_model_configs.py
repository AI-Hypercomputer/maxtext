...
llama3_1_405b_8192_fsdp_dcn_mlperf_gbs4096 = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="llama3-1-405b-8192-fsdp-dcn-mlperf-2",
    model_type="llama3.1-405b",
...
llama3_1_405b_8192_fsdp_dcn_mlperf_gbs3072 = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="llama3-1-405b-8192-fsdp-dcn-mlperf-2",
    model_type="llama3.1-405b",
...
llama3_1_405b_8192_fsdp_dcn_mlperf_2_int8 = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="llama3-1-405b-8192-fsdp-dcn-mlperf-2",
    model_type="llama3.1-405b",
    tuning_params={
        ...
        "dataset_path": "gs://trillium-scale-datasets-q1-25-west",
        "enable_checkpointing": True,
        "load_parameters_path": "gs://mlperf-llama3/mlperf50_llama405b_checkpoints/scanned_sharded/0/items",
        "dataset_type": "c4_mlperf",
        "dataset_name": "c4/en:3.0.7",
        "eval_dataset_name": "c4/en:3.0.9",
