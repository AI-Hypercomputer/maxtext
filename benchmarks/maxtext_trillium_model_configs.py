...
from benchmarks.globals import ASSETS_ROOT
...
llama2_70b_4096_real_data_long_run = _add_to_model_dictionary(
    ...
    MaxTextModel(
        ...
        tuning_params={
            ...
            "dataset_path": "gs://max-datasets-rogue",
            "dataset_type": "tfds",
            "tokenizer_path": os.path.join(ASSETS_ROOT, "tokenizer.llama2"),
            "sa_block_q": 1024,
            "sa_block_q_dkv": 2048,
            "sa_block_q_dq": 2048,
        },
...
llama3_1_70b_8192_iter_real_data_and_checkpointing_tfds = _add_to_model_dictionary(
    ...
    MaxTextModel(
        ...
        tuning_params={
            ...
            "tokenizer_path": os.path.join(ASSETS_ROOT, "tokenizer_llama3.tiktoken"),
        },
        xla_flags=(
            xla_flags_library.DENSE_VMEM_LIMIT_FLAG
            + xla_flags_library.LAYOUT_FOR_ALL_REDUCE_SCATTER
...
mixtral_8x7b_dropped = _add_to_model_dictionary(
    ...
    MaxTextModel(
        ...
        tuning_params={
            ...
            "tokenizer_path": os.path.join(ASSETS_ROOT, "tokenizer.mistral-v1"),
        },
        xla_flags=(
            xla_flags_library.MOE_VMEM_LIMIT_FLAG
            + xla_flags_library.CF_FOR_ALL_GATHER
...
mixtral_8x22b_dropped = _add_to_model_dictionary(
    ...
    MaxTextModel(
        ...
        tuning_params={
            ...
            "sparse_matmul": False,
            "capacity_factor": 1.25,
            "tokenizer_path": os.path.join(ASSETS_ROOT, "tokenizer.mistral-v3"),
            "dtype": "bfloat16",
            "weight_dtype": "bfloat16",
            "allow_split_physical_axes": True,
            "custom_mesh": "hybrid_ring_64x4",
