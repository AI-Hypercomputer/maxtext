...
default_32 = _add_to_model_dictionary(
  ...
  MaxTextModel(
    ...
    xla_flags=(xla_flags_library.DENSE_VMEM_LIMIT_FLAG + xla_flags_library.CF_FOR_ALL_GATHER),
  ),
)
...
llama2_70b_4096_sc_real_data_grain = _add_to_model_dictionary(
  ...
  MaxTextModel(
    ...
    tuning_params={
      ...
      "use_iota_embed": True,
      "dataset_path": "gs://trillium-storage-datasets-sr",
      "base_output_directory": ("gs://trillium-storage-tests-nov24-sr/long-run-dec11"),
      "enable_checkpointing": False,
      "dataset_type": "grain",
      "grain_train_files": (
...
llama3_1_405b_8192_fsdp_dcn = _add_to_model_dictionary(
  ...
  MaxTextModel(
    ...
    xla_flags=(
      xla_flags_library.DENSE_VMEM_LIMIT_FLAG + xla_flags_library.CF_FOR_ALL_GATHER + xla_flags_library.HOST_OFFLOAD_FLAGS
    ),
    pathways_xla_flag_options={
      xla_flags_library.REMOVE: ["--2a886c8_chip_config_name=megachip_tccontrol"],
      xla_flags_library.ADD_SERVER: (xla_flags_library.ENHANCED_LAUNCH_BARRIER),
