...
llama3_1_70b = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
...
maxtext_150b = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="maxtext-150b",
    model_type="default",
    tuning_params={
        "base_emb_dim": 12288,
...
maxtext_120b_custom = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="maxtext-120b",
    model_type="default",
    tuning_params={
        "base_emb_dim": 8192,
