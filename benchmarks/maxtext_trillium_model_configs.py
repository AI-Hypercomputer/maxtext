...
llama3_1_405b_8192_fsdp_dcn_mlperf_pathways = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
    model_name="llama3-1-405b-8192-fsdp-dcn-mlperf-pathways",
    model_type="llama3.1-405b",
    tuning_params={
        "per_device_batch_size": 1,
        "ici_fsdp_parallelism": 256,
        ...
        # "load_parameters_path": "gs://qinwen-mlperf/llama405_perf/qinwen/qinwe-llama3-1-405-2-031820-fbf/checkpoints/0/items",
        ...
        # "dataset_path": "/tmp/dataset/trillium-scale-datasets-q1-25-west",
        "dataset_type": "c4_mlperf",
        "dataset_name": "c4/en:3.0.7",
        "eval_dataset_name": "c4/en:3.0.9",
        # "profiler": "xplane",
        # "skip_first_n_steps_for_profiler": 45,
        # "profiler_steps": 5,
        "steps": 500,
...
llama3_1_405b_8192_fsdp_dcn_mlperf_2 = _add_to_model_dictionary(
  trillium_model_dict,
  MaxTextModel(
