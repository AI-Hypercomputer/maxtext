...
#include "third_party/tensorflow/compiler/xla/pjrt/cpu/gloo_collectives.h"
...
#include "third_party/tensorflow/compiler/xla/service/collective_ops_utils.h"
#include "third_party/tensorflow/compiler/xla/service/cpu/collectives_interface.h"
#include "third_party/tensorflow/compiler/xla/service/global_device_id.h"
...
#include "third_party/tensorflow/tsl/platform/logging.h"
...
GlooCollectives::GetCommunicator(
  ...
  context->setTimeout(std::chrono::seconds(60));
