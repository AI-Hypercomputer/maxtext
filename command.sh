...
RUN_NAME=${TPU_TYPE}_${MODEL}_test_per_device_batch_size$BATCH_SIZE-ici_tensor_parallelism$ici_tensor_parallelism-xla_tpu_scoped_vmem_limit_kib$xla_tpu_scoped_vmem_limit_kib-$remat_policy
NODE_COUNT=1
