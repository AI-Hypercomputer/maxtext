...
export WORKLOAD_IMAGE="gcr.io/tpu-prod-env-one-vm/param3_21jul:latest"
export WORKLOAD_NAME="mohit-qn80b-v6e-${TIMESTAMP}"
...
/usr/local/google/home/mohitkhatwani/max_venv/bin/xpk workload create \
  ...
  --base-docker-image="gcr.io/tpu-prod-env-one-vm/param3_21jul:latest" \
