...
def run_shard_perf():
    ...
    #run_job("mattdavidow-test-shard-count", base_shard_perf(), 2)
    for pv_count in [1,2,256]:
        run_job(f"mattdavidow-test-shard-count-pv-{pv_count}", base_shard_perf(), 2, local_aqt_shards_pv=pv_count)
