...
python3 MaxText/generate_param_only_checkpoint.py MaxText/configs/base.yml load_parameters_path=${converted_checkpoint_path}/0/items run_name=${PARAMETER_CHECKPOINT_RUN} model_name='llama2-13b' force_unroll=true
