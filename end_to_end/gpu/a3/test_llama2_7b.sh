...
python3 -m MaxText.generate_param_only_checkpoint MaxText/configs/base.yml \
...
python3 -m MaxText.decode MaxText/configs/base.yml \
  load_parameters_path="${BASE_OUTPUT_DIRECTORY}/${RUN_NAME}/checkpoints/0/items" \
  run_name="runner_decode_finetuned_${idx}" \
  base_output_directory="${BASE_OUTPUT_DIRECTORY}" \
