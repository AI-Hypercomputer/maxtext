...
python3 MaxText/train.py MaxText/configs/base.yml run_name=$RUN_NAME\
    ...
    enable_profiler=false remat_policy=full base_emb_dim=12288 base_mlp_dim=49152\
    base_num_heads=32 base_num_decoder_layers=40 head_dim=256\
    max_target_length=1024 metrics_file='metrics.txt' base_output_directory=$OUTPUT_PATH\
