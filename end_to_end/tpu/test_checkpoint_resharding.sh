...
python3 -m MaxText.train src/MaxText/configs/base.yml run_name=$RUN_NAME steps=101\
...
python3 -m MaxText.train src/MaxText/configs/base.yml run_name=$RUN_NAME steps=102\
