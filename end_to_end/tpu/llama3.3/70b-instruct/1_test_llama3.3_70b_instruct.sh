...
# Example Usage: export BASE_OUTPUT_PATH=/path/to/GCS/bucket; bash end_to_end/tpu/llama3.3/70b-instruct/1_test_llama3.3_70b_instruct.sh
# Use the same BASE_OUTPUT_PATH as end_to_end/tpu/llama3.3/70b-instruct/2_test_llama3.3_70b_instruct.sh.
# Please note that in these two scripts (1_test_llama3.3_70b_instruct.sh and 2_test_llama3.3_70b_instruct.sh) BASE_OUTPUT_PATH is assumed to be already a unique path across multiple runs and 
# the subfolders names aka RUN_NAMEs are static. Please remember to change BASE_OUTPUT_PATH across different runs.ex

set -ex
MODEL_VARIATION='llama3.3-70b-instruct'
