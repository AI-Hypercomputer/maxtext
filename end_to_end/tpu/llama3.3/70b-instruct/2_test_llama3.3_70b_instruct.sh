...
# Please make sure you have run end_to_end/tpu/llama3.3/70b-instruct/1_test_llama3.3_70b_instruct.sh before running commands from this file. 

# The flow of this file is as follows:
# 1. Run decoding, finetuning of Llama3.3-70B-Instruct with the converted checkpoint obtained from end_to_end/tpu/llama3.3/70b-instruct/1_test_llama3.3_70b_instruct.sh. Also, run pretraining of Llama3.3-70B-Instruct
...
# Example Usage: export BASE_OUTPUT_PATH=/path/to/GCS/bucket; bash end_to_end/tpu/llama3.3/70b-instruct/2_test_llama3.3_70b_instruct.sh
# Use the same BASE_OUTPUT_PATH as end_to_end/tpu/llama3.3/70b-instruct/1_test_llama3.3_70b_instruct.sh
...
export MODEL_VARIATION='llama3.3-70b-instruct'
...
# We defined path to unscanned checkpoint created in 1_test_llama3.3_70b_instruct.sh
export UNSCANNED_CKPT_PATH=${BASE_OUTPUT_PATH}/${RUN_NAME}/checkpoints/0/items

# To use our pre-converted checkpoint from huggingface, uncomment below two lines to override
