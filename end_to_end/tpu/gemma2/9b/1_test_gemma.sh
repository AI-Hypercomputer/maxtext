...
JAX_PLATFORMS=cpu python MaxText/convert_gemma2_chkpt.py --base_model_path ${CHKPT_BUCKET}/9b --maxtext_model_path ${SCANNED_CHECKPOINT} --model_size 9b
...
python3 MaxText/gemma2_orbax_to_hf.py MaxText/configs/base.yml base_output_directory=gs://runner-maxtext-logs load_parameters_path=${SCANNED_CHECKPOINT} run_name=convert_to_hf model_name=${MODEL} async_checkpointing=${ASYNC_CHECKPOINTING} hf_model_path=/tmp/gemma2
