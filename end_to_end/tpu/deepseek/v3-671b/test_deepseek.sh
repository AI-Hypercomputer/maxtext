...
JAX_PLATFORMS=cpu python3 -m MaxText.convert_deepseek_family_ckpt --base_model_path ${CHKPT_BUCKET} --src/MaxText_model_path ${MODEL_BUCKET}/${idx} --model_size ${MODEL_NAME}
...
JAX_PLATFORMS=cpu python3 -m MaxText.convert_deepseek_family_unscanned_ckpt --base_model_path ${CHKPT_BUCKET} --src/MaxText_model_path ${MODEL_BUCKET}/${idx}/unscanned --model_size ${MODEL_NAME}
