...
python3 MaxText/train.py MaxText/configs/base.yml run_name=$RUN_NAME\
    steps=12 per_device_batch_size=12.0 learning_rate=1e-3 enable_checkpointing=false\
...
python3 end_to_end/eval_assert.py checkpoint_save_restore metrics.txt $LOSS_THRESHOLD
