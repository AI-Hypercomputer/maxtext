...
PYTHONPATH=src/ /home/liyinn_google_com/anaconda3/envs/maxtext/bin/python3 -m maxtext.inference.sampler \
    ...
    > output_decode_${MODEL_NAME?}_${NOW}.txt 2>&1
